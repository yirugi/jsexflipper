from .jsexflipper_option import JSExFlipperOption, PromotionalMethod, BusinessProcessData
from .jsexflipper import JSExFlipper
...
def tampering_worker(tp_q:multiprocessing.Queue, jsexf: JSExFlipper):
...
class JSExFlipperLauncher:
    def __init__(self, option: JSExFlipperOption, passing: BusinessProcessData, blocking: BusinessProcessData,
    ...
    def perform_analysis(self):
        jsexf = JSExFlipper(self.option, self.promotional_method)
        jsexf.make_test_dir()
...
class JSExFlipperLauncherAntiAdblocker(JSExFlipperLauncher):
    def __init__(self, option: JSExFlipperOption, page: str):
        self.option = option
...
class JSExFlipperLauncherHardPaywall(JSExFlipperLauncher):
    def __init__(self, option: JSExFlipperOption, login_js, sub_pages, passing_pages=None):
        passing_data = BusinessProcessData()
...
class JSExFlipperLauncherSoftPaywall(JSExFlipperLauncher):
    def __init__(self, option: JSExFlipperOption, paywall_pages, free_pages):
        passing_data = BusinessProcessData()
...
class JSExFlipperLauncherHybridPaywall(JSExFlipperLauncher):
    def __init__(self, option: JSExFlipperOption, free_pages, sub_pages):
        passing_data = BusinessProcessData()
        passing_data.pages = free_pages
