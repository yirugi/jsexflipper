exports.test = async function(pb, dumpio, devtool){
	...
	await pb.start_browser(dumpio, devtool, true,["--user-data-dir=/mnt/hgfs/tool/dist/examples/workingdir/ocregister/tmpdir/inst1/chrome_dir"]);
	await new Promise(r => setTimeout(r, 3000));
	await pb.page.bringToFront();
	pb.saveResult("111", 15000);
